...
const customJestConfig = {
  ...
  setupFilesAfterEnv: [`<rootDir>/config/jest/jest.setup.js`, `<rootDir>/config/jest/models.jest.setup.js`, `jest-extended/all`],
  testEnvironment: 'jest-environment-jsdom',
  testPathIgnorePatterns: [`/node_modules/`, `/.cache/`, `/public/`, `/__specs__/`, `/specs/`, `/cdk/`],
  testMatch: [`<rootDir>/models/**/?(*.)+(test).[jt]s?(x)`],
  transform: {
